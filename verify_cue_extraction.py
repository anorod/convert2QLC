...
def main():
    # Read the test file
    test_file_path = Path("docs/test_files/20260220-TestSimplePicolo.txt")
    ...
    checks = [
        ...
        ("First cue description", "Cue inicial" in result),
        ("Second cue description", "Cue 2 segunda auto" in result),
        ("Third cue description", "Cue BK" in result),
        ("Fourth cue description", "Cue 1 canal" in result),
        ("Fifth cue description", "Un decimal en la Cue" in result),
        ("Sixth cue description", "Otra Cue BK" in result),
